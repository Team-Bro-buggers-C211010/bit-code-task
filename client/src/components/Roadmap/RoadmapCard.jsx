    ...
    return (
        <div className="bg-white rounded-lg border border-gray-200 p-6 shadow hover:shadow-lg transition">
            ...
            <p className="text-sm text-gray-600 mb-4">
                Align all input fields and spacing across the roadmap module to ensure visual consistency.
            </p>

            <div className="flex justify-between items-center">
                <p className="flex items-center gap-2 text-sm px-3 py-1.5 border border-yellow-400 text-yellow-500 rounded">
                    <button><AiOutlineLike className="text-neutral-950 hover:text-yellow-400 hover:font-semibold text-lg cursor-pointer transition-colors duration-200" /></button>12
                </p>
